...
char* pPtr = arrGreeting;             //비상수 포인터, Pointer
                                      //비상수 데이터

const char* pPtr = arrGreeting;       //비상수 포인터, Pointer to Constant
                                      //상수 데이터

char* const pPtr = arrGreeting;       //상수 포인터,	  Constant Pointer
                                      //비상수 데이터

const char* const pPtr = arrGreeting; //상수 포인터,	  Constant Pointer to Constant
	                                    //상수 데이터
```
### 함수
