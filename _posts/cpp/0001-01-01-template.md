...
템플릿의 종류에는 크게 2가지가 존재하지만 그전에 앞서 공통적으로 사용되는<br>
...
typename 키워드는 클래스를 생성할 때 사용되는 class와 혼동되지 않도록 나중에 추가된 키워드입니다.<br><br>
<br>
...
3
```
여기서 주의해야 할 점은 int num의 값 매개 변수를 함수의 매개 변수에 넣지 않는다는 점입니다.
