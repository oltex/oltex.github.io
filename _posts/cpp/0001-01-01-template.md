...
void main(void) {
	...
	std::cout << calc_num<float>(0.1f) << std::endl; //결과: 0.2 난 0.01를 원한다!
}
```
템플릿의 특수화는 크게 2가지 방식이 있습니다. 완전 특수화와 부분 특수화 입니다.<br>
#### 완전 특수화
...
```
마지막으로 맴버 함수 템플릿입니다. 위쪽에서 봤던 T와 U를 사용하여 멤버 함수에 대한 케이스를 구현하겠습니다.<br>
