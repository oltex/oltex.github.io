...
SystemProfile\Tasks
```
### 오디오(Audio) 캡처(Capture) 디스플레이 후처리(DisplayPostProcessing) 배포(Distribution) 게임(Games) 재생(Playback)
```
\Audio \Capture \DisplayPostProcessing \Distribution \Games
```

|이름               |종류      |데이터(기본값)|오디오(Audio)|캡처(Capture)|디스플레이 후처리(DisplayPostProcessing)|배포(Distribution)|게임(Games)|재생(Playback)|
|---|---|---|---|---|---|---|---|---|
|Affinity           |REG_DWORD|             |0x00000000(0)    |0x00000000(0)    |0x00000000(0)    |0x00000000(0)    |0x00000000(0)    |0x00000000(0)    |
|Background Only    |REG_SZ   |             |True             |True             |True             |True             |False            |False            |
|BackgroundPriority |REG_DWORD|             |                 |                 |0x00000008(8)    |                 |                 |0x00000004(4)    |
|Clock Rate         |REG_DWORD|AAAAAAAAAAAAA|0x00002710(10000)|0x00002710(10000)|0x00002710(10000)|0x00002710(10000)|0x00002710(10000)|0x00002710(10000)|
|GPU Priority       |REG_DWORD|             |0x00000008(8)    |0x00000008(8)    |0x00000008(8)    |0x00000008(8)    |0x00000008(8)    |0x00000008(8)    |
|Latency Sensitive  |REG_SZ   |             |                 |                 |                 |                 |                 |                 |
|Priority           |REG_DWORD|             |0x00000006(6)    |0x00000006(5)    |0x00000008(8)    |0x00000008(4)    |0x00000008(2)    |0x00000008(3)    |
|Scheduling Category|REG_SZ   |             |Medium           |Medium           |High             |Medium           |Medium           |Medium           |
|SFIO Priority      |REG_SZ   |             |Normal           |Normal           |Normal           |Normal           |Normal           |Normal           |
